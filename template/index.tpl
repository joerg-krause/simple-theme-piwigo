...
<header class="titrePage">
  ...
  <ul class="categoryActions">
    {if isset($U_EDIT)}
    <li><a href="{$U_EDIT}" title="{'edit album informations'|@translate}"><i class="glyphicon glyphicon-edit"></i></a></li>
    {/if}
    {if isset($U_SLIDESHOW)}
    <li><a href="{$U_SLIDESHOW}" title="{'slideshow'|@translate}" rel="nofollow"><i class="glyphicon glyphicon-play"></i></a></li>
    {/if}
